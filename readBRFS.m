...
% loads in the info from the text files from BRFS. These a are what Michele
% and Kacie made the stimuli code do... Whenever ML runs a task, on every
% task, the info about the stim presented on that file is saved in the text
% file. 

% This tells you what the stimulus was.
...
if n < datenum('01/15/2016','mm/dd/yyyy');
    ...
    fields = {...
        ...
        'tilt',...
        'sf',...
        'phase',... % added phase on Jan 15, 2016 (change logged in git), MAC
        'diameter',...
        'eye',...
        'eye_contrast',...
        'other_contrast',...
